    ...
    return (
        <Section title="Tech Stack">
            <Transition component={Container} fade={false} stall={0.1}>
                <TechBlock title="Leadership" items="Team Lead,Architecture Design,Code Review,Mentorship" />
                ...
                <TechBlock title="Tools" items="GitHub Copilot,Claude,OpenAI,SonarCube,SentrySwagger,Figma,Mural" />
            </Transition>
            <SectionLinks>
