...
export default function Home() {
    ...
    return <div className="page">
        ...
        <Chapter title="For hire" background>
            <Trans tag="p">
                As I'm currently located in Chiang Mai, Thailand, I work remotely and at a fixed hourly rate. For questions or inquiries, feel free to contact me by <Link href={`mailto:hi@${window.location.host}`}>email</Link> or through <Link href="https://linkedin.com/in/emroni">LinkedIn</Link>.
            </Trans>
        </Chapter>
